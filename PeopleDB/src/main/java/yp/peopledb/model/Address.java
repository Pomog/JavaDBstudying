...
public final class Address {
    ...
    public Address(@Id Long id, String streetAddress, String address2, String city, String state, String zip, String country,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, streetAddress, address2, city, state, zip, country, county, region);
    }
